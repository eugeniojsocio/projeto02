...
import com.example.gera_imagem.databinding.ActivityDetalhesprodutoBinding
...
class detalhesproduto : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_detalhesproduto)
